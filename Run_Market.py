...
def run_market(td, ta):
    td.straight_drive(430)  # next code is all about the silo
    ...
    td.turn(10)
    td.straight_drive(-72)  # change to get the right position for the lever
    run_task(ta.move_C_angle(215))  # dropping for lever
    td.straight_drive(20)  # the go forward before moving the lever
