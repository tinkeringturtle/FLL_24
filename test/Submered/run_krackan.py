# Author: Meghana, Emma, Sunny (meganator is the sigma one tho)
#
...
def run_kracken(td, ta):
    ...
    # run_task(ta.move_C_angle(350)) commment out, but now start in up position
    td.turn(10)
    td.straight_drive(450)
    td.turn(80)
    td.set_speed_percentage(speed_percentage=65, acceleration_percentage=55)
    td.straight_drive(125)
    td.set_speed_percentage(speed_percentage=15, acceleration_percentage=10)
    ...
    run_task(ta.move_D_angle(-90))  # grab kracken
    ...
    # td.turn(-90)
    td.set_speed_percentage(speed_percentage=80, acceleration_percentage=85)
